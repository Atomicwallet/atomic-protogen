...
export const MsgUnbondValidator: MessageFns<MsgUnbondValidator> = {
  encode(message: MsgUnbondValidator, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.validatorAddress !== "") {
...
export const MsgUnbondValidatorResponse: MessageFns<MsgUnbondValidatorResponse> = {
  encode(_: MsgUnbondValidatorResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgTokenizeShares: MessageFns<MsgTokenizeShares> = {
  encode(message: MsgTokenizeShares, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.delegatorAddress !== "") {
      writer.uint32(10).string(message.delegatorAddress);
    }
    if (message.validatorAddress !== "") {
...
export const MsgTokenizeSharesResponse: MessageFns<MsgTokenizeSharesResponse> = {
  encode(message: MsgTokenizeSharesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.amount !== undefined) {
...
export const MsgRedeemTokensForShares: MessageFns<MsgRedeemTokensForShares> = {
  encode(message: MsgRedeemTokensForShares, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.delegatorAddress !== "") {
      writer.uint32(10).string(message.delegatorAddress);
    }
    if (message.amount !== undefined) {
...
export const MsgRedeemTokensForSharesResponse: MessageFns<MsgRedeemTokensForSharesResponse> = {
  encode(message: MsgRedeemTokensForSharesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.amount !== undefined) {
      Coin.encode(message.amount, writer.uint32(10).fork()).join();
    }
    return writer;
...
export const MsgTransferTokenizeShareRecord: MessageFns<MsgTransferTokenizeShareRecord> = {
  encode(message: MsgTransferTokenizeShareRecord, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.tokenizeShareRecordId = reader.uint64().toString();
          continue;
        }
        case 2: {
          if (tag !== 18) {
...
export const MsgTransferTokenizeShareRecordResponse: MessageFns<MsgTransferTokenizeShareRecordResponse> = {
  encode(_: MsgTransferTokenizeShareRecordResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgDisableTokenizeShares: MessageFns<MsgDisableTokenizeShares> = {
  encode(message: MsgDisableTokenizeShares, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.delegatorAddress !== "") {
      writer.uint32(10).string(message.delegatorAddress);
    }
    return writer;
...
export const MsgDisableTokenizeSharesResponse: MessageFns<MsgDisableTokenizeSharesResponse> = {
  encode(_: MsgDisableTokenizeSharesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgEnableTokenizeShares: MessageFns<MsgEnableTokenizeShares> = {
  encode(message: MsgEnableTokenizeShares, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.delegatorAddress !== "") {
      writer.uint32(10).string(message.delegatorAddress);
    }
    return writer;
...
export const MsgEnableTokenizeSharesResponse: MessageFns<MsgEnableTokenizeSharesResponse> = {
  encode(message: MsgEnableTokenizeSharesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.completionTime !== undefined) {
      Timestamp.encode(toTimestamp(message.completionTime), writer.uint32(10).fork()).join();
    }
    return writer;
...
export const MsgValidatorBond: MessageFns<MsgValidatorBond> = {
  encode(message: MsgValidatorBond, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.delegatorAddress !== "") {
      writer.uint32(10).string(message.delegatorAddress);
    }
    if (message.validatorAddress !== "") {
...
export const MsgValidatorBondResponse: MessageFns<MsgValidatorBondResponse> = {
  encode(_: MsgValidatorBondResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
